...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb://walter0001white:ofecCKdEJDlOq4z4@<hostname>/?ssl=true&replicaSet=atlas-147r0k-shard-0&authSource=admin&retryWrites=true&w=majority&appName=Cluster0")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5560200410").split()):
        ADMINS.append(int(x))
except ValueError:
